...
const Quiz = {
  quizData: [
    {
      question:
        "Which formwork system is most suitable for constructing circular structures such as silos or storage tanks?",
      a: "Tunnel formwork",
      b: "Slipform",
      c: "Timber formwork",
      d: "Shoring towers ",
...
const Scenes = {
  ...
  steps: [
        ...
        Dom.animePush(
          anime
            ...
            .add({
              ...
              keyframes: [{ top: 10 }, { left: 10 }, { left: 0, top: 0 }],
            })
            .add({
    ...
    (step3 = function () {
      ...
      // * Required Elements
      Scenes.items.column_front_panel.set(0, 0).zIndex(3);
      Scenes.items.column_front_push_prop_1.set(0, 0).zIndex(3);
      Scenes.items.column_front_push_prop_2.set(0, 0).zIndex(3);  
      Scenes.items.column_front_kicker_brace.set(0, 0).zIndex(3);
      Scenes.items.column_front_push_prop_pin_1.set(0, 0).zIndex(3);
      Scenes.items.column_front_push_prop_pin_2.set(0, 0).zIndex(3);
    ...
    (step4 = function () {
      ...
      setIsProcessRunning(true);
      Scenes.items.contentAdderBox.setContent("");
      Scenes.setStepHeading("Step 3", "Attaching external conrer to connect all the sides of a column.");
        ...
        Dom.animePush(
          anime
            ...
            .add({
              ...
              keyframes: [{ top: 0 }, { left: -10 }, { top: 0, left: 0 }],
            })
            .add({
        ...
        Dom.animePush(
          anime
            ...
            .add({
              ...
              keyframes: [{ left: 0 }, { top: -10 }, { top: 0, left: 0 }],
            })
            .add({
    ...
    (step5 = function () {
      setIsProcessRunning(true);
      Dom.hideAll();
      Scenes.setStepHeading("Step 4", "Add wedge pin to connect panel and corner rigidly.");
        ...
        Dom.animePush(
          anime
            ...
            .add({
              ...
              keyframes: [{ top: 5 }, { left: 5 }, { top: 0, left: 0 }],
            })
            .add({
